...
public class FlightsParser {
    ...
    public static Tuple2<Tuple2<Integer, Integer>, Flights> parseFlightsFile(String row) {
        ...
        return new Tuple2<>(new Tuple2<>(originAirportID, destAirportID), new Flights(originAirportID, destAirportID, delay, isCanceled));
    }
